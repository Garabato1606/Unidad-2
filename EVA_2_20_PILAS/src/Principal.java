...
class Pilas {
    ...
    public int pop() {//QUITA EL ULTIMO NODO
        if (nIni == null) {
            return 0;
        } else {
            ...
            if (nIni.getnSig() == null) {
                ...
                nFin = nFin.getnPrev(); //nfin lo movimos al numero anterior
                nFin.setnSig(null); // entamos borrando el siguiente numero (el que era el ultimo)
            }
            return iValor;
        }
    }
